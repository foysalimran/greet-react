              ...
              >
                <li className="nav-item dropdown submenu">
                  <Link
                    ...
                    aria-expanded="false"
                  >
                    <Trans i18nKey="headerApps.home.title">
                      {header.home.title}
                    </Trans>
                  ...
                  >
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerApps.home.dropdownItem1">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerApps.home.dropdownItem2">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerApps.home.dropdownItem3">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerApps.home.dropdownItem4">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerApps.home.dropdownItem5">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerApps.home.dropdownItem6">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerApps.feature.title">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerApps.about.title">
                      {header.about.title}
                    </Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerApps.screenshot.title">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerApps.pricing.title">
                ...
                <li className="nav-item dropdown submenu">
                  <Link
                    ...
                    aria-expanded="false"
                  >
                    <Trans i18nKey="headerApps.blog.title">
                      {header.blog.title}
                    </Trans>
                  ...
                  >
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerApps.blog.blogDropdown1">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerApps.blog.blogDropdown2">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerApps.contact.title">
