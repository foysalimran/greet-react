              ...
              >
                <li className="nav-item dropdown submenu">
                  <Link
                    ...
                    aria-expanded="false"
                  >
                    <Trans i18nKey="headerDigital.home.title">
                      {header.home.title}
                    </Trans>
                  ...
                  >
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerDigital.home.dropdownItem1">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerDigital.home.dropdownItem2">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerDigital.home.dropdownItem3">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerDigital.home.dropdownItem4">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerDigital.home.dropdownItem5">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerDigital.home.dropdownItem6">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerDigital.about.title">
                      {header.about.title}
                    </Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerDigital.portfolio.title">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerDigital.faq.title">
                      {header.faq.title}
                    </Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerDigital.pricing.title">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerDigital.testimonial.title">
                ...
                <li className="nav-item dropdown submenu">
                  <Link
                    ...
                    aria-expanded="false"
                  >
                    <Trans i18nKey="headerDigital.blog.title">
                      {header.blog.title}
                    </Trans>
                  ...
                  >
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerDigital.blog.blogDropdown1">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerDigital.blog.blogDropdown2">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerDigital.contact.title">
