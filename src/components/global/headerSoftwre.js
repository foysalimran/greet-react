              ...
              >
                <li className="nav-item dropdown submenu">
                  <Link
                    ...
                    aria-expanded="false"
                  >
                    <Trans i18nKey="headerSoftware.home.title">
                      {header.home.title}
                    </Trans>
                  ...
                  >
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerSoftware.home.dropdownItem1">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerSoftware.home.dropdownItem2">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerSoftware.home.dropdownItem3">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerSoftware.home.dropdownItem4">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerSoftware.home.dropdownItem5">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerSoftware.home.dropdownItem6">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerSoftware.about.title">
                      {header.about.title}
                    </Trans>
                  </Link>
                </li>
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerSoftware.overview.title">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerSoftware.pricing.title">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerSoftware.faq.title">
                      {header.faq.title}
                    </Trans>
                  </Link>
                </li>
                <li className="nav-item dropdown submenu">
                  <Link
                    ...
                    aria-expanded="false"
                  >
                    <Trans i18nKey="headerSoftware.blog.title">
                      {header.blog.title}
                    </Trans>
                  ...
                  >
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerSoftware.blog.blogDropdown1">
                    ...
                    <li className="nav-item">
                      <PageLink
                        ...
                        className="nav-link"
                      >
                        <Trans i18nKey="headerSoftware.blog.blogDropdown2">
                ...
                <li className="nav-item">
                  <Link
                    ...
                    offset={-60}
                  >
                    <Trans i18nKey="headerSoftware.contact.title">
